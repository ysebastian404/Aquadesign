...
try {
    ...
    $usuarios = [
        ...
        ['Maria Lopez', 'maria.lopez@correo.com', 'maria123', 'cliente', 'activo'],
        ['Carlos Sanchez', 'carlos.sanchez@correo.com', 'carlos456', 'cliente', 'activo'],
    ...
    $clientes = [
        [2, 'Avenida Reforma 123, CDMX', '555-1234567'],
        [3, 'Calle Juarez 456, Guadalajara', '333-9876543']
    ];
    ...
    $productos = [
        ...
        ['Pecera Hexagonal', 'Creativo', 'Pequeña', 1100.25, 25, 'Diseños  creativos.'],
        ['Pecera Tropical', 'Exótico', 'Extra Grande', 2700.00, 8, 'Diseños exótico "Fantasia".']
    ];
    ...
    $pedidos = [
        [1, 3400.75, 'pendiente', 'Avenida Reforma 123, CDMX'],
        [2, 4500.00, 'en_proceso', 'Calle Juarez 456, Guadalajara']
    ];
